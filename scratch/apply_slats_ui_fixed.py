...
# Exact whitespace matching (34 spaces for container, 36 for inner items, 32 for closing div, 30 for closing switch expression)
...
if old_part in code:
    ...
    if old_part_lf in code_lf:
        ...
        print("Error: sidebar switches block still not found.")

with open(filepath, "w", encoding="utf-8") as f:
    f.write(code)
print("Sidebar controls update script executed.")
