...
import { X, Printer, CheckSquare, Square, Loader2, Image as ImageIcon, Settings, Camera, CameraOff, ImageOff, DollarSign, Tag, Percent, Save, RotateCcw, FileDown, Users, Megaphone, Calendar, CircleCheck, LayoutGrid, Palette, Columns, Check, Trash2, Eye, EyeOff, ClipboardList } from 'lucide-react';
