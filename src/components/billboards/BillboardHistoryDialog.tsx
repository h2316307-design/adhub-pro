            ...
            history.map((record) => (
              ...
              >
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-3">
                  ...
                  {record.billboard_rent_price && record.billboard_rent_price > 0 && (
                    <div>
                      <div className="text-xs text-muted-foreground">سعر اللوحة</div>
                      <div className="font-semibold text-blue-600">
                        {Number(record.billboard_rent_price).toLocaleString()} دينار
                      </div>
                    </div>
                  )}
                  {record.total_before_discount && record.total_before_discount > 0 && (
                    <div>
                      <div className="text-xs text-muted-foreground">المبلغ قبل الخصم</div>
                      <div className="font-semibold text-foreground">
                        {Number(record.total_before_discount).toLocaleString()} دينار
                      </div>
                    </div>
                  )}
                    ...
                    <div>
                      ...
                      <div className="font-semibold text-orange-500">
                        ...
                        {record.discount_percentage && record.discount_percentage > 0 && (
                          <span className="text-xs mr-1">({Number(record.discount_percentage).toFixed(1)}%)</span>
                        )}
                      </div>
                    </div>
                  )}
                  {record.installation_cost && record.installation_cost > 0 && (
                    <div>
                      ...
                      <div className="font-semibold text-purple-600">
                        {Number(record.installation_cost).toLocaleString()} دينار
                      </div>
                    </div>
                  )}
                  <div>
                  ...
                  {record.design_name && (
                    <div>
                      ...
                      <div className="text-sm text-foreground">{record.design_name}</div>
                    </div>
                  )}
                </div>
