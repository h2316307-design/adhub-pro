...
const BillboardGridCardInner: React.FC<BillboardGridCardProps> = ({
  ...
  useEffect(() => {
    ...
    img.src = designImage;
  }, [latestTask, (billboard as any).design_face_a, activeContract]);
  ...
  return (
    <>
      ...
      >
        ...
        {/* ✅ Card Actions Dropdown - top left */}
        {(onEdit || onDelete || onContractAction || onMaintenance) && (
          <div className="absolute top-3 left-3 z-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
        ...
        {/* شريط لوني علوي بلون التصميم */}
        {dominantColor && (
          <div 
            className="h-1 w-full" 
            style={{ background: `linear-gradient(90deg, rgba(${dominantColor}, 0.8), rgba(${dominantColor}, 1), rgba(${dominantColor}, 0.8))` }}
          />
        )}
        ...
        <div className="relative">
          ...
          <div 
            ...
            style={dominantColor ? {
              background: `linear-gradient(to right, rgba(${dominantColor}, 0.12), rgba(${dominantColor}, 0.05))`,
              borderBottomColor: `rgba(${dominantColor}, 0.25)`,
            } : {
