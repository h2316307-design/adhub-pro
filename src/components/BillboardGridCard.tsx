...
import { MapPin, Calendar, Building, Eye, User, FileText, Clock, Camera, ChevronDown, ChevronUp, CheckCircle2, XCircle, History, EyeOff, Wrench, CalendarPlus, Pencil, ImageIcon, Check, ZoomIn, X } from 'lucide-react';
    ...
    const loadActiveContract = async () => {
      ...
      try {
        const { data: contractData } = await supabase
          ...
          .or(`billboard_ids.ilike.%,${idStr},%,billboard_ids.ilike.${idStr},%,billboard_ids.ilike.%,${idStr},billboard_ids.eq.${idStr}`)
          .gte('"End Date"', today)
