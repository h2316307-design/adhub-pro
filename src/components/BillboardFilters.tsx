...
const QuickStatus: React.FC<QuickStatusProps> = ({ label, emoji, isActive, onClick, variant }) => {
  const variants = {
...
export const BillboardFilters: React.FC<BillboardFiltersProps> = ({
  ...
  // ✅ الحالات السريعة
  const quickStatuses = [
    { label: 'متاحة', value: 'متاحة', emoji: '🟢', variant: 'success' as const },
    { label: 'قريبة الانتهاء', value: 'قريبة الانتهاء', emoji: '🟠', variant: 'warning' as const },
    { label: 'محجوز', value: 'محجوز', emoji: '🔴', variant: 'danger' as const },
    { label: 'قيد الصيانة', value: 'قيد الصيانة', emoji: '🔧', variant: 'info' as const },
    { label: 'مخفية', value: 'مخفية من المتاح', emoji: '👁️', variant: 'muted' as const },
  ];
