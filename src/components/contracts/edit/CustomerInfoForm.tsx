      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <Popover open={customerOpen} onOpenChange={setCustomerOpen}>
            ...
            <PopoverContent className="p-0 bg-popover border-border z-[10000]">
              <Command>
                <CommandInput 
                  ...
                  <CommandGroup>
                    ...
                    {customerQuery && !(customers || []).some((x) => x.name === customerQuery.trim()) && (
                      <CommandItem
                        ...
                        className="hover:bg-accent cursor-pointer text-primary"
                      >
                        إضافة "{customerQuery}" كعميل جديد
                      </CommandItem>
                    )}
        ...
        <div>
          ...
          <Input 
            ...
            placeholder="مثال: مواد صحية، أدوات منزلية..."
