            ...
            <div className="space-y-4">
              ...
              {paymentMode === 'multiple' && (
                <Card className="p-4 bg-background/50 border-border space-y-3">
                  ...
                  {useCustomLastDate ? (
                    <div className="animate-in slide-in-from-top-2">
                      <label className="text-sm font-bold text-foreground block mb-2">موعد آخر دفعة</label>
                      <Input
                        type="date"
              ...
              >
                ...
                <p className="text-xs text-destructive text-center mt-1">
                  {!startDate && 'يرجى تحديد تاريخ بداية العقد أولاً'}
                  {startDate && hasDifferentFirstPayment && actualFirstPayment < 0 && 'قيمة الدفعة الأولى لا يمكن أن تكون سالبة'}
                  {startDate && hasDifferentFirstPayment && actualFirstPayment > finalTotal && 'قيمة الدفعة الأولى أكبر من إجمالي العقد'}
                </p>
              )}
            </div>
          </Card>
