...
export function RemovalTaskCard({
  ...
  return (
    <Card className={cn(
      ...
      <div className="relative flex flex-row-reverse min-h-[180px]" dir="ltr">
        ...
        {uniqueDesignImages.length > 0 && (
          <div className="relative w-32 sm:w-40 md:w-48 flex-shrink-0 border-l border-border/30">
            ...
            <div className="absolute bottom-1 left-1 z-20 flex flex-col gap-1">
              <Badge className="text-[10px] px-1.5 py-0.5 bg-red-600/90 text-white border-0 backdrop-blur-sm gap-1">
        ...
        <div className="flex-1" dir="rtl">
          <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
            ...
            <CollapsibleTrigger asChild>
              <div className="flex items-center justify-center py-2 cursor-pointer hover:bg-accent/50 transition-colors border-t border-border/50">
                <motion.div
