...
export function EnhancedDistributePaymentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] flex flex-col z-50">
                ...
                <div className="space-y-3 border-t pt-3">
                  ...
                  {collectedViaIntermediary && (
                    <div className="grid grid-cols-2 gap-4 p-3 bg-muted/50 rounded-lg">
                      ...
                      <div className="col-span-2 p-2 bg-background rounded border border-primary/20">
                        <div className="text-sm space-y-1">
                          ...
                          <div className="flex justify-between pt-1 border-t border-primary/20 text-lg font-bold text-primary">
                            <span>الصافي:</span>
