...
export function ExpensesPrintDialog({
  ...
  const filteredTotals = useMemo(() => {
    ...
    return {
      ...
      remainingPool: poolTotal - totals.totalWithdrawn
    };
  }, [filteredContracts, closures, excludedIds, totals.totalWithdrawn]);
      ...
      if (printWindow) {
        ...
        printWindow.document.write(`
          ...
          <head>
            ...
            <title>كشف مصروفات التشغيل - ${filterText}</title>
            <style>
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        ...
        <div ref={printRef} className="space-y-4" dir="rtl">
          ...
          <div className="footer">
            <p>نظام إدارة اللوحات الإعلانية - مصروفات التشغيل</p>
