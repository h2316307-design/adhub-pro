            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  placeholder="0"
                  className="bg-input border-border text-foreground text-lg font-bold text-right"
                  dir="ltr"
                />
              ...
              {totalAmount && Number(totalAmount) >= 1000 && (
                <p className="text-xs text-muted-foreground">
                  {Number(totalAmount) >= 1000000 
                    ? `${(Number(totalAmount) / 1000000).toFixed(2)} مليون`
                    : `${(Number(totalAmount) / 1000).toFixed(2)} ألف`}
                </p>
              )}
            </div>
