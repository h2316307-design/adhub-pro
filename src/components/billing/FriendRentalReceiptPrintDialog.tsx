          ...
          <div class="receipt-container">
            <div class="header">
              <div class="receipt-info">
                <div class="receipt-title">فاتورة إيجار لوحة</div>
                <div class="receipt-details">
                  <div>رقم الفاتورة: ${receiptNumber}</div>
                  <div>التاريخ: ${receiptDate}</div>
                </div>
              </div>
              
              <div class="company-info">
                <img 
                  src="/coplete logofares-text. and sympol.svg" 
                  alt="شعار الشركة" 
                  class="company-logo"
                />
                <div class="company-details">
                  شركة فارس العالمية للدعاية والإعلان<br>
                  العنوان: طرابلس، ليبيا<br>
                  الهاتف: +218 91 234 5678<br>
                  البريد الإلكتروني: info@faresads.ly
                </div>
              </div>
            </div>
            ...
            <div class="footer">
              ...
              <p>فارس العالمية للدعاية والإعلان - جميع الحقوق محفوظة © ${new Date().getFullYear()}</p>
            </div>
          </div>
        </body>
        </html>
