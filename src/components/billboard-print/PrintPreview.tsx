...
export function PrintPreview({
  ...
  const pageHTML = useMemo(() => {
    ...
    if (includeDesigns && hasDesigns) {
      html += `
        <div class="absolute-field designs-section" data-element-key="designs" style="top: ${s.designs_top}; left: ${s.designs_left}; width: ${s.designs_width}; display: flex; flex-direction: column; gap: ${s.designs_gap}; align-items: center; ${hl('designs')}">
          ${effectiveDesignA ? `
