                ...
                onClick={() => {
                  ...
                  const mappedContract = {
                    ...
                    billboard_prices: JSON.stringify(selectedBBs.map((b: any) => {
                      ...
                      return {
                        billboardId: b.ID,
                        finalPrice: Math.round(netRentalAfterDiscount + billboardInstallCost),
                        baseRental: billboardPrice,
                        installationCost: billboardInstallCost,
                        netRentalBeforeDiscount,
                        discountPerBillboard: Math.round(discountPerBillboard),
                        netRentalAfterDiscount: Math.round(netRentalAfterDiscount),
                        priceBeforeDiscount: billboardPrice,
                        priceAfterDiscount: Math.round(netRentalAfterDiscount + billboardInstallCost),
                      };
                    })),
