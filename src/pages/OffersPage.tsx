...
export default function OffersPage() {
  ...
  const handleEditOffer = (offer: Offer) => {
    ...
    // Load customer company and phone from customers list
    if (offer.customer_id) {
      ...
      if (customer) {
        ...
        supabase.from('customers').select('company, phone').eq('id', offer.customer_id).single()
          .then(({ data }) => {
            if (data) {
              setSelectedCustomerCompany(data.company || null);
