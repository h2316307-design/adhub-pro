      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-2xl bg-gradient-to-br from-purple-500 to-pink-600 text-white shadow-xl shadow-purple-500/25">
          ...
          <div className="flex gap-2">
            ...
            <Button 
              ...
              size="sm" 
              className="gap-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white shadow-lg shadow-purple-500/25"
            >
        ...
        {stats.noPrinter > 0 && (
          <Card className="border-purple-300 dark:border-purple-800 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <Card className="lg:col-span-4 border-border/50 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-purple-500/5 to-pink-500/5 border-b border-border/50 pb-4 space-y-4">
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg flex items-center gap-2">
                  <Scissors className="h-5 w-5 text-purple-600 dark:text-purple-400" />
                  قائمة المهام
                </CardTitle>
                <Badge variant="secondary" className="bg-purple-100 dark:bg-purple-950/50 text-purple-700 dark:text-purple-400">
          ...
          <Card className="lg:col-span-8 border-border/50 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-pink-500/5 to-purple-500/5 border-b border-border/50">
              <CardTitle className="text-lg flex items-center gap-2">
