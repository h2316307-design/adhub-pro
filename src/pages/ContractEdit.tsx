      ...
      const updates: any = {
        ...
        billboard_prices: JSON.stringify(selectedBillboardsData.map(b => {
          ...
          return {
            ...
            // contractPrice = الإيجار الأساسي البحت (قبل الخصم وقبل التكاليف الإضافية)
            // هذا هو ما يُسترد عند إعادة فتح العقد لضمان صحة الحسابات
            contractPrice: baseBillboardPrice,
            finalPrice: totalBillboardPrice, // السعر النهائي بعد الخصم والتكاليف
