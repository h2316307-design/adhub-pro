...
function CustomerRow({ 
  ...
  return (
    <TableRow className={rowClassName}>
      ...
      <TableCell className="text-right text-green-600">{customer.totalPaid.toLocaleString('ar-LY')} د.ل</TableCell>
      <TableCell className="text-right text-blue-600 font-semibold">{customer.accountBalance.toLocaleString('ar-LY')} د.ل</TableCell>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card className="border-green-500/20 bg-gradient-to-br from-green-500/5 to-transparent">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-green-600">{customersSummary.reduce((s, c) => s + c.totalRent, 0).toLocaleString('ar-LY')} <span className="text-lg">د.ل</span></div>
          </CardContent>
        </Card>
        ...
        <Card className="border-blue-500/20 bg-gradient-to-br from-blue-500/5 to-transparent">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-blue-600">{totalAllPaid.toLocaleString('ar-LY')} <span className="text-lg">د.ل</span></div>
          </CardContent>
        </Card>
        ...
        <Card className="border-red-500/20 bg-gradient-to-br from-red-500/5 to-transparent">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-red-600">{customersSummary.reduce((s, c) => s + (c.totalRent - c.totalPaid), 0).toLocaleString('ar-LY')} <span className="text-lg">د.ل</span></div>
          </CardContent>
        </Card>
      </div>
