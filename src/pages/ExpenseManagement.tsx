                        ...
                        <TableRow key={expense.id}>
                          ...
                          <TableCell className="text-sm">
                            {expense.receiver_name && (
                              <div><span className="font-semibold">المستلم:</span> {expense.receiver_name}</div>
                            )}
                            {expense.sender_name && (
                              <div><span className="font-semibold">المسلم:</span> {expense.sender_name}</div>
                            )}
                            {!expense.receiver_name && !expense.sender_name && '—'}
                          </TableCell>
                          <TableCell>
                            <div className="flex gap-2">
                              <Button
