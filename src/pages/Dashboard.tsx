...
export default function Dashboard() {
  ...
  const openWhatsAppDialog = useCallback((phone: string, message: string, title: string) => {
    setWhatsappDialog({ open: true, phone: phone || '', message, title });
  }, []);
